/*=============================================================================
    vp8_decoder.c — FFmpeg libavcodec VP8 video decoder implementation
=============================================================================*/
...
static zst_result_t
vp8_init_decoder(vp8_decoder_t* s)
{
    const AVCodec* codec = avcodec_find_decoder(AV_CODEC_ID_VP8);
    if (!codec) {
        fprintf(stderr, "vp8_decoder: VP8 decoder not found (libvpx needed)\n");
        return ZST_ERROR;
    }
