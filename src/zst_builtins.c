...
static const zst_property_spec_t g_builtin_srtsrc_props[] = {
    ...
    { "mss", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "the Maximum Transfer Unit" },
    { "fc", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Flight flag size (window size)" },
    { "sndtimeo", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "send() timeout" },
    { "rcvtimeo", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "recv() timeout" },
    { "tsbpdmode", ZST_PROPERTY_BOOL, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Enable/Disable TsbPd. Enable -> Tx set origin timestamp, Rx deliver packet at origin time + delay" },
    { "rcvlatency", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "" },
    { "peerlatency", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "" },
    { "inputbw", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Estimated input stream rate." },
    { "oheadbw", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "MaxBW ceiling based on % over input stream rate. Applies when UDT_MAXBW=0 (auto)." },
    { "ipttl", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "IP Time To Live (passthru for system sockopt IPPROTO_IP/IP_TTL)" },
    { "iptos", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "IP Type of Service (passthru for system sockopt IPPROTO_IP/IP_TOS)" },
    { "snddropdelay", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Extra delay towards latency for sender TLPKTDROP decision (-1 to off)" },
    { "nakreport", ZST_PROPERTY_BOOL, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Enable receiver to send periodic NAK reports" },
    { "conntimeo", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Connect timeout in msec. Caller default: 3000, rendezvous (x 10)" },
    { "drifttracer", ZST_PROPERTY_BOOL, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Enable or disable drift tracer" },
    { "mininputbw", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Minimum estimate of input stream rate." },
    { "lossmaxttl", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Maximum possible packet reorder tolerance (number of packets to receive after loss to send lossreport)" },
    { "congestion", ZST_PROPERTY_STRING, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Congestion controller type selection" },
    { "messageapi", ZST_PROPERTY_BOOL, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "In File mode, use message API (portions of data with boundaries)" },
    { "kmrefreshrate", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "After sending how many packets the encryption key should be flipped to the new key" },
    { "kmpreannounce", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "How many packets before key flip the new key is announced and after key flip the old one decommissioned" },
    { "enforcedencryption", ZST_PROPERTY_BOOL, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Connection to be rejected or quickly broken when one side encryption set or bad password" },
    { "ipv6only", ZST_PROPERTY_BOOL, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "IPV6_V6ONLY mode" },
    { "peeridletimeo", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Peer-idle timeout (max time of silence heard from peer) in [ms]" },
    { "bindtodevice", ZST_PROPERTY_STRING, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Forward the SOL_SOCKET/SO_BINDTODEVICE option on socket (pass packets only from that device)" },
    { "packetfilter", ZST_PROPERTY_STRING, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Add and configure a packet filter" },
    { "retransmitalgo", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "An option to select packet retransmission algorithm" },
    { "cryptomode", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Encryption cipher mode (AES-CTR, AES-GCM, ...)." },
    { "maxrexmitbw", ZST_PROPERTY_INT, ZST_PROPERTY_READABLE | ZST_PROPERTY_WRITABLE, "", "Maximum bandwidth limit for retransmision (Bytes/s)" }
};
